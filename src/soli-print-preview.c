...
struct _SoliPrintPreview
{
	 ...
	 * the SoliPrintPreview itself because when a toolbar item has the
...
G_DEFINE_TYPE (SoliPrintPreview, soli_print_preview, GTK_TYPE_GRID)
...
static void
soli_print_preview_grab_focus (GtkWidget *widget)
{
	SoliPrintPreview *preview = SOLI_PRINT_PREVIEW (widget);
...
static gint
get_n_pages (SoliPrintPreview *preview)
{
	gint n_pages;
...
static gdouble
get_screen_dpi (SoliPrintPreview *preview)
{
	GdkScreen *screen;
	gdouble dpi;
 ...
 */
static gdouble
get_paper_width (SoliPrintPreview *preview)
{
 ...
 */
static void
get_tile_size (SoliPrintPreview *preview,
	       gint              *tile_width,
	       gint              *tile_height)
{
	if (tile_width != NULL)
...
static void
set_zoom_factor (SoliPrintPreview *preview,
		 gdouble            zoom)
{
	preview->scale = zoom;
...
static void
zoom_in (SoliPrintPreview *preview)
{
...
static void
goto_page (SoliPrintPreview *preview,
           gint               page)
{
	gchar *page_str;
	gint n_pages;
...
static gint
get_first_page_displayed (SoliPrintPreview *preview)
{
...
static void
soli_print_preview_init (SoliPrintPreview *preview)
{
	preview->cur_page = 0;
	preview->scale = 1.0;
	preview->n_columns = 1;
...
static void
init_last_page_label (SoliPrintPreview *preview)
{
	gchar *str;
