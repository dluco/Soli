...
G_DEFINE_TYPE (SoliAppX11, soli_app_x11, SOLI_TYPE_APP)
...
static void
soli_app_add_platform_data (GApplication    *app,
                             GVariantBuilder *builder)
{
  G_APPLICATION_CLASS (soli_app_x11_parent_class)->add_platform_data (app, builder);
...
static void
soli_app_x11_class_init (SoliAppX11Class *klass)
{
	GApplicationClass *app_class = G_APPLICATION_CLASS (klass);

	app_class->add_platform_data = soli_app_add_platform_data;
}

static void
soli_app_x11_init (SoliAppX11 *self)
{
}
