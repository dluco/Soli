/*
 * soli-app-file-chooser-dialog.h
...
G_DEFINE_INTERFACE (SoliFileChooserDialog, soli_file_chooser_dialog, G_TYPE_OBJECT)
...
static void
soli_file_chooser_dialog_default_init (SoliFileChooserDialogInterface *iface)
{
...
{
#ifdef OS_OSX
	return soli_file_chooser_dialog_osx_create (title,
	                                             parent,
	                                             flags,
	                                             encoding,
	                                             cancel_label,
	                                             ...
	                                             accept_response);
#else
	return soli_file_chooser_dialog_gtk_create (title,
	                                             parent,
	                                             flags,
	                                             encoding,
	                                             cancel_label,
...
void
soli_file_chooser_dialog_set_encoding (SoliFileChooserDialog  *dialog,
                                        const GtkSourceEncoding *encoding)
{
	SoliFileChooserDialogInterface *iface;

	g_return_if_fail (SOLI_IS_FILE_CHOOSER_DIALOG (dialog));

	iface = SOLI_FILE_CHOOSER_DIALOG_GET_IFACE (dialog);
...
soli_file_chooser_dialog_get_encoding (SoliFileChooserDialog *dialog)
{
	...
	g_return_val_if_fail (SOLI_IS_FILE_CHOOSER_DIALOG (dialog), NULL);
...
void
soli_file_chooser_dialog_set_newline_type (SoliFileChooserDialog *dialog,
...
soli_file_chooser_dialog_get_newline_type (SoliFileChooserDialog *dialog)
{
	...
	g_return_val_if_fail (SOLI_IS_FILE_CHOOSER_DIALOG (dialog), GTK_SOURCE_NEWLINE_TYPE_DEFAULT);
...
void
soli_file_chooser_dialog_set_current_folder (SoliFileChooserDialog *dialog,
                                              GFile                  *folder)
{
	SoliFileChooserDialogInterface *iface;
...
void
soli_file_chooser_dialog_set_current_name (SoliFileChooserDialog *dialog,
                                            const gchar            *name)
{
	SoliFileChooserDialogInterface *iface;
...
void
soli_file_chooser_dialog_set_file (SoliFileChooserDialog *dialog,
                                    GFile                  *file)
{
	SoliFileChooserDialogInterface *iface;
...
GSList *
soli_file_chooser_dialog_get_files (SoliFileChooserDialog *dialog)
{
	SoliFileChooserDialogInterface *iface;
...
GFile *
soli_file_chooser_dialog_get_file (SoliFileChooserDialog *dialog)
{
	SoliFileChooserDialogInterface *iface;
...
void
soli_file_chooser_dialog_set_do_overwrite_confirmation (SoliFileChooserDialog *dialog,
...
void
soli_file_chooser_dialog_show (SoliFileChooserDialog *dialog)
{
	SoliFileChooserDialogInterface *iface;
...
void
soli_file_chooser_dialog_hide (SoliFileChooserDialog *dialog)
{
	SoliFileChooserDialogInterface *iface;
...
void
soli_file_chooser_dialog_destroy (SoliFileChooserDialog *dialog)
{
	SoliFileChooserDialogInterface *iface;
...
void
soli_file_chooser_dialog_set_modal (SoliFileChooserDialog *dialog,
                                     gboolean                is_modal)
{
	SoliFileChooserDialogInterface *iface;
...
GtkWindow *
soli_file_chooser_dialog_get_window (SoliFileChooserDialog *dialog)
{
	SoliFileChooserDialogInterface *iface;
...
void
soli_file_chooser_dialog_add_pattern_filter (SoliFileChooserDialog   *dialog,
                                              const gchar              *name,
                                              const gchar              *pattern)
{
	SoliFileChooserDialogInterface *iface;
