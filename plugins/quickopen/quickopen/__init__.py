...
from gi.repository import GObject, Gio, GLib, Gtk, Soli

from .popup import Popup
from .virtualdirs import RecentDocumentsDirectory
from .virtualdirs import CurrentDocumentsDirectory

class QuickOpenAppActivatable(GObject.Object, Soli.AppActivatable):
...
class QuickOpenPlugin(GObject.Object, Soli.WindowActivatable):
    ...
    def on_activated(self, gfile, user_data=None):
        Soli.commands_load_location(self.window, gfile, None, -1, -1)
        return True
