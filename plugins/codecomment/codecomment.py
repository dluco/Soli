...
from gi.repository import GObject, Gio, Gtk, GtkSource, Soli
...
class CodeCommentAppActivatable(GObject.Object, Soli.AppActivatable):
...
class CodeCommentWindowActivatable(GObject.Object, Soli.WindowActivatable):

    window = GObject.Property(type=Soli.Window)
...
class CodeCommentViewActivatable(GObject.Object, Soli.ViewActivatable):
